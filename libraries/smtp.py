...
def send_email_to_many(subject, body, sender, recipients, user, password):
    msg = MIMEMultipart()
    msg['Subject'] = subject
    msg['From'] = sender
...
def send_email_Attachments_to_many(subject, body, sender, recipients, user, password, files):
    msg = MIMEMultipart()
    msg['Subject'] = subject
    msg['From'] = sender
    msg['To'] = ", ".join(recipients)
